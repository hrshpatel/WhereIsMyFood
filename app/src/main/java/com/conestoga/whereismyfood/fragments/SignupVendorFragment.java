...
public class SignupVendorFragment extends Fragment implements View.OnClickListener {

    private TabLayout mTabLayout;
    private APIInterface mApiInterface;
    private EditText mEdtVendorName;
    private EditText mEdtVEmail;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.frg_signup_btn_v_signup:
                validateUserInput();
                break;
        }
    }
    ...
    private void initializeView(View view) {
        ...
        mEdtVendorName = view.findViewById(R.id.frg_signup_edt_vname);
        mEdtPhoneNo = view.findViewById(R.id.frg_signup_edt_phone);
        mEdtVEmail = view.findViewById(R.id.frg_signup_edt_vemail);
        mEdtPassword = view.findViewById(R.id.frg_signup_edt_v_password);
        mEdtCnfrmPwd = view.findViewById(R.id.frg_signup_edt_v_cnfm_pwd);
    ...
    private void validateUserInput() {
        String mStrVendorName = mEdtVendorName.getText().toString().trim();
        String mStrPhoneNo = mEdtPhoneNo.getText().toString().trim();
        String mStrEmail = mEdtVEmail.getText().toString().trim();
        ...
        if (CommonUtils.isNullString(mStrVendorName)) {
            ...
            Toast.makeText(getActivity()
                    ...
                    , Toast.LENGTH_SHORT).show();
        } else if (CommonUtils.isNullString(mStrPhoneNo)) {
            Toast.makeText(getActivity(), "" + getResources().getString(R.string.toast_no_phone)
                    , Toast.LENGTH_SHORT).show();
        } else if (!CommonUtils.checkPhoneNo(mStrPhoneNo)) {
            Toast.makeText(getActivity(), "" + getResources().getString(R.string.toast_invalid_phone)
                    , Toast.LENGTH_SHORT).show();
            ...
            if (CommonUtils.isInternetAvailable(getActivity())) {
                ...
                userDetails.setPhoneNo(mStrPhoneNo);
